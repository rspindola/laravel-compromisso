...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <title>Salão XXXXXXXXXXXXXXX - E-mail de Confirmação de agendamento</title>
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                              ...
                              <tr>
                                <td class="td-padding" align="left" style="font-family: 'Roboto Mono', monospace; color: #212121!important; font-size: 24px; line-height: 30px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 13px;">
                                  Olá, {{$appointment['client_id']}}!
                                </td>
                              </tr>
                              <tr>
                                <td class="td-padding" align="left" style="font-family: 'Roboto Mono', monospace; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 18px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                  Esse e-mail é para lembrar do seu agendamento no XXXXXXXXXXXXXXX, com o funcionário {{$appointment->employee->name}} na data {{ \Carbon\Carbon::parse($appointment->start_time)->format('d/m/Y H:i') }}. Caso não consiga comparecer, por favor, entre em contato para o cancelamento.
                                  <br><br>
                                  Att, Equipe do Salão.
                                </td>
                              </tr>
