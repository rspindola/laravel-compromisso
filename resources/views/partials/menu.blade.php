                ...
                <ul class="pcoded-item pcoded-left-item">
                    @can('user_management_access')
                        <li class="pcoded-hasmenu">
                            <a href="javascript:void(0)">
                                ...
                                <span class="pcoded-mtext" data-i18n="nav.dash.main">{{ trans('cruds.userManagement.title') }}</span>
                                ...
                                @can('permission_access')
                                    <li class="">
                                        <a href="{{ route("admin.permissions.index") }}">
                                            ...
                                            <span class="pcoded-mtext" data-i18n="nav.dash.default">{{ trans('cruds.permission.title') }}</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                @endcan
                                @can('role_access')
                                    <li class="">
                                        <a href="{{ route("admin.roles.index") }}">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext" data-i18n="nav.dash.default">{{ trans('cruds.role.title') }}</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                @endcan
                                @can('user_access')
                                    <li class="">
                                        <a href="{{ route("admin.users.index") }}">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext" data-i18n="nav.dash.default">{{ trans('cruds.user.title') }}</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                @endcan
                    ...
                    <li class="">
                        <a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">
                            <span class="pcoded-micon"><i class="ti-file"></i><b>D</b></span>
                            <span class="pcoded-mtext"
                                data-i18n="nav.documentation.main">{{ trans('global.logout') }}</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
            ...
            <ul class="pcoded-item pcoded-left-item">
                <li class="">
                    <a href="../doc/index.html" target="_blank">
                        <span class="pcoded-micon"><i class="ti-file"></i><b>D</b></span>
                        <span class="pcoded-mtext"
                            data-i18n="nav.documentation.main">Documentation</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                </li>
                <li class="">
