                    ...
                    <div class="main-friend-list">
                        <div class="media userlist-box" data-id="1" data-status="online"
                            ...
                            <a class="media-left" href="#!">
                                <img class="media-object" src="{{asset('assets/files/assets/images/avatar-1.jpg')}}"
                        ...
                        <div class="media userlist-box" data-id="2" data-status="online"
                            ...
                            title="Lary Doe">
                            <a class="media-left" href="#!">
                                <img class="media-object" src="{{asset('assets/files/assets/images/avatar-2.jpg')}}"
                                    alt="Generic placeholder image">
                                <div class="live-status bg-success"></div>
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice"
                            ...
                            <a class="media-left" href="#!">
                                <img class="media-object" src="{{asset('assets/files/assets/images/avatar-3.jpg')}}"
                                    alt="Generic placeholder image">
                                <div class="live-status bg-success"></div>
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia"
                            ...
                            <a class="media-left" href="#!">
                                <img class="media-object" src="{{asset('assets/files/assets/images/avatar-4.jpg')}}"
                                    alt="Generic placeholder image">
                                <div class="live-status bg-success"></div>
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media userlist-box" data-id="5" data-status="online" data-username="Suzen"
                            ...
                            <a class="media-left" href="#!">
                                <img class="media-object" src="{{asset('assets/files/assets/images/avatar-5.jpg')}}"
                                    alt="Generic placeholder image">
                                <div class="live-status bg-success"></div>
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media userlist-box" data-id="6" data-status="offline"
                            ...
                            <a class="media-left" href="#!">
                                <img class="media-object" src="{{asset('assets/files/assets/images/avatar-6.jpg')}}"
                                    alt="Generic placeholder image">
                        ...
                        <div class="media userlist-box" data-id="7" data-status="online"
                            ...
                            title="Irina Shayk">
                            <a class="media-left" href="#!">
                                <img class="media-object" src="{{asset('assets/files/assets/images/avatar-7.jpg')}}"
                                    alt="Generic placeholder image">
                                <div class="live-status bg-success"></div>
                            </a>
                            <div class="media-body">
    ...
    <div class="showChat_inner">
        <div class="media chat-inner-header">
            <a class="back_chatBox">
                <i class="icofont icofont-rounded-left"></i> Renato
            </a>
        </div>
        <div class="media chat-messages">
            <a class="media-left photo-table" href="#!">
                <img class="media-object img-circle m-t-5" src="{{asset('assets/files/assets/images/avatar-1.jpg')}}"
                    alt="Generic placeholder image">
            </a>
        ...
        <div class="media chat-messages">
            ...
            <div class="media-right photo-table">
                <a href="#!">
                    <img class="media-object img-circle m-t-5" src="{{asset('assets/files/assets/images/user.png')}}"
                        alt="Generic placeholder image">
                </a>
            </div>
        </div>
