        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card widget-card-1">
                    <div class="card-block-small">
                        ...
                        <span class="text-c-blue f-w-600">Clientes</span>
                        <h4>{{count($clientes)}}</h4>
                        <div>
                            <a href="{{route('admin.clients.index')}}">
                                <span class="f-left m-t-10 text-muted">
                                    <i class="text-c-blue f-16 icofont icofont-warning m-r-10"></i> Ver mais
                                </span>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card widget-card-1">
                    <div class="card-block-small">
                        ...
                        <span class="text-c-green f-w-600">Compromissos</span>
                        <h4>{{count($compromissos)}}</h4>
                        <div>
                            <a href="{{route('admin.appointments.index')}}">
                                <span class="f-left m-t-10 text-muted">
                                    <i class="text-c-green f-16 icofont icofont-tag m-r-10"></i> Veja mais
                                </span>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card widget-card-1">
                    <div class="card-block-small">
                        ...
                        <span class="text-c-pink f-w-600">Faturamento</span>
                        <h4>R$ {{$faturamento}}</h4>
                        <div>
                            <span class="f-left m-t-10 text-muted">
                                <i class="text-c-pink f-16 icofont icofont-calendar m-r-10"></i> No mês
                            </span>
                        </div>
                    </div>
                </div>
            ...
            {{-- <div class="col-md-6 col-xl-3">
                <div class="card widget-card-1">
                    <div class="card-block-small">
                        ...
                        <span class="text-c-yellow f-w-600">Funcionários</span>
                        <h4>{{count($funcionarios)}}</h4>
                        <div>
                            <a href="{{route('admin.employees.index')}}">
                                <span class="f-left m-t-10 text-muted">
                                    <i class="text-c-yellow f-16 icofont icofont-refresh m-r-10"></i>Veja mais
                                </span>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-md-12 col-xl-4">
                <div class="card card-blue total-card">
                    <div class="card-block">
                        <div class="text-left">
                            <h4>{{count($compromissos)}}</h4>
                            <p class="m-0">Total de Compromissos</p>
                        </div>
                        <span class="label bg-c-blue value-badges">no último ano</span>
                    </div>
                ...
                <div class="card card-pink total-card">
                    <div class="card-block">
                        ...
                        <span class="label bg-c-pink value-badges">no último ano</span>
                    </div>
            ...
            <div class="col-md-12 col-xl-4">
                <div class="card widget-statstic-card">
                    <div class="card-header">
                        <div class="card-header-left">
                            <h5>Statistics</h5>
                            <p class="p-t-10 m-b-0 text-c-blue">Compared to last week
                            </p>
                        </div>
                    </div>
                    <div class="card-block">
                ...
                <div class="card widget-statstic-card">
                    <div class="card-header">
                        <div class="card-header-left">
                            ...
                            <p class="p-t-10 m-b-0 text-c-pink">55% from last 28 hours
                            </p>
                        </div>
                    </div>
                    <div class="card-block">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card widget-statstic-card">
                    <div class="card-header">
                        <div class="card-header-left">
                            <h5>Novos compromissos</h5>
                            <p class="p-t-10 m-b-0 text-c-yellow">54% do ultimo mês
                            </p>
                        </div>
                    </div>
                    <div class="card-block">
            ...
            <div class="col-md-12 col-xl-6">
                <div class="card add-task-card">
                    <div class="card-header">
                        <div class="card-header-left">
                            <h5>Próximos Serviços</h5>
                        </div>
                        <div class="card-header-right">
                            <button class="btn btn-card btn-primary">Adicionar Serviço </button>
                        </div>
                    </div>
                    <div class="card-block">
                        <div class="to-do-list">
                            <div class="checkbox-fade fade-in-primary d-block">
                                <label class="check-task d-block">
                                    ...
                                    <span class="todo-main"><span>Schedule Meeting with
                                            Compnes </span><span class="label bg-c-green m-l-10 f-10">2
                                            week</span></span>
                                    <span class="task-card-img m-l-40 d-block">
                                        <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-2.jpg')}}"
                                                data-toggle="tooltip" title="Lary Doe" alt="" class="img-40"></a>
                                        <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-3.jpg')}}"
                                                data-toggle="tooltip" title="Alia" alt="" class="img-40 m-l-10"></a>
                                    </span>
                                </label>
                            </div>
                        </div>
                        <div class="to-do-list">
                            <div class="checkbox-fade fade-in-primary d-block">
                                <label class="check-task d-block">
                                    ...
                                    <span class="todo-main"><span>Meeting With HOD's and
                                            borad</span></span><span class="text-muted m-l-40 d-block">23 january
                                        2003</span>
                                </label>
                            </div>
                        </div>
                        <div class="to-do-list">
                            <div class="checkbox-fade fade-in-primary d-block">
                                <label class="check-task d-block">
                                    ...
                                    <span class="todo-main"><span>Create template, admin
                                            with responsive</span><span class="label bg-c-pink m-l-10">2
                                            week</span></span>
                                    <span class="task-card-img m-l-40 d-block">
                                        <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-2.jpg')}}"
                                                data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                        <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-3.jpg')}}"
                                                data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-10"></a>
                                        <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-4.jpg')}}"
                                                data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-10"></a>
                                        <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-2.jpg')}}"
                        ...
                        <div class="to-do-list">
                            <div class="checkbox-fade fade-in-primary d-block">
                                <label class="check-task d-block">
                                    ...
                                    <span class="todo-main"><span>Meeting With HOD's and
                                            borad</span></span>
                                    <span class="text-muted m-l-40 d-block">23 january
                                        2003</span>
                                    <span class="task-card-img m-l-40 d-block">
                                        <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-2.jpg')}}"
                                                data-toggle="tooltip" title="Lary Doe" alt="" class="img-40"></a>
                    ...
                    <div class="card-block weather-update">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <svg version="1.1" id="cloudSun" style="height:160px;"
                                    class="climacon climacon_cloudSun" viewBox="15 15 70 70">
                ...
                <div class="card card-contact-box ">
                    <div class="card-block ">
                        <div class="card-contain text-center ">
                            <img src="{{asset('assets/files/assets/images/avatar-2.jpg')}}" alt=" ">
                            <h6 class="f-w-400 f-20 p-b-5 m-0 p-t-15 ">Gregory Johan
                            </h6>
                            <a href="#! "><span class="__cf_email__"
                                    data-cfemail="771005121018050e591d181f16193713121a185914181a">[email&#160;protected]</span></a>
                            <p class="text-muted p-b-25 m-0 p-t-5 ">Software Developer
                            </p>
                            <div class="contain-card p-t-30 p-b-10 ">
                                <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-4.jpg')}}"
                                        data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-3.jpg')}}"
                                        data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-5"></a>
                                <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-4.jpg')}}"
                                        data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-5"></a>
                                <a href="#!"><img src="{{asset('assets/files/assets/images/avatar-2.jpg')}}"
                                        data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-5"></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row m-0">
                            <div class="col-6 f-btn text-center b-r-default p-t-15 p-b-15 ">
                                <a href="#!">
                                    ...
                                    <p class="text-muted m-0 text-uppercase d-inline-block ">
                                        Messages</p>
                                </a>
                            </div>
                ...
                <div class="card ">
                    ...
                    <div class="card-block p-0">
                        <div class="card-comment ">
                            <div class="card-block-small">
                                <img class="img-radius img-50"
                                    src="{{asset('assets/files/assets/images/avatar-4.jpg')}}" alt="user-1">
                                <div class="comment-desc">
                                    <h6>Luciano Durk</h6>
                                    <p class="text-muted ">Lorem Ipsum is simply dummy
                        ...
                        <div class="card-comment ">
                            <div class="card-block-small">
                                <img class="img-radius img-50"
                                    src="{{asset('assets/files/assets/images/avatar-3.jpg')}}" alt="user-4">
                                <div class="comment-desc">
                                    <h6>John Doe</h6>
                                    <p class="text-muted ">Lorem Ipsum is simply dummy
                                        text of the printing and typesetting industry.
                        ...
                        <div class="card-comment ">
                            <div class="card-block-small">
                                <img class="img-radius img-50"
                                    src="{{asset('assets/files/assets/images/avatar-4.jpg')}}" alt="user-2">
                                <div class="comment-desc">
                                    <h6>Planner Board</h6>
                                    <p class="text-muted ">Lorem Ipsum is simply dummy
                                        text of the printing and typesetting industry.
                        ...
                        <div class="card-comment ">
                            <div class="card-block-small">
                                <img class="img-radius img-50"
                                    src="{{asset('assets/files/assets/images/avatar-2.jpg')}}" alt="user-3">
                                <div class="comment-desc">
                                    <h6>Luciano Durk</h6>
                                    <p class="text-muted ">Lorem Ipsum is simply dummy
                                        text of the printing and typesetting industry.
...
@endsection
@section('scripts')
<script src="{{asset('assets/files/assets/pages/widget/amchart/amcharts.min.js')}}"></script>
<script src="{{asset('assets/files/assets/pages/widget/amchart/serial.min.js')}}"></script>
<script type="text/javascript" src="{{asset('bower_components/chart.js/js/Chart.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/files/assets/pages/todo/todo.js')}}"></script>
