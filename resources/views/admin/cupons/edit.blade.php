        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h4>{{ trans('global.edit') }} {{ trans('cruds.cupon.title_singular') }}</h4>
            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">{{ trans('global.edit') }} {{ trans('cruds.cupon.title_singular') }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route("admin.cupons.update", [$cupon->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                <label for="name">{{ trans('cruds.cupon.fields.name') }}*</label>
                                <input type="text" id="name" name="name" class="form-control" value="{{ old('name', isset($cupon) ? $cupon->name : '') }}" required>
                                @if($errors->has('name'))
                            ...
                            <div class="form-group {{ $errors->has('discount') ? 'has-error' : '' }}">
                                ...
                                <input type="number" id="discount" name="discount" class="form-control" value="{{ old('discount', isset($cupon) ? $cupon->discount : '') }}" maxlength="3" max="100">
