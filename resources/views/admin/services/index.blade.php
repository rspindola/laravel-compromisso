        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h4>{{ trans('cruds.service.title') }}</h4>
                        <span>Lista de serviços cadastrados no sistema</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">{{ trans('cruds.service.title') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                @can('service_create')
                                    <div class="row">
                                        <div class="col-lg-12 text-right">
                                            <a class="btn btn-sm btn-success" href="{{ route("admin.services.create") }}">
