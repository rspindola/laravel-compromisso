        ...
        <div class="row align-items-end">
            <div class="col-lg-6">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h4>{{ trans('global.create') }} {{ trans('cruds.appointment.title_singular') }}</h4>
                        <span>Formulário de criação de compromisso no sistema</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">{{ trans('global.create') }} {{ trans('cruds.appointment.title_singular') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" id="price" name="price" 
                                            class="form-control money" value="{{ old('price', isset($appointment) ? $appointment->price : '') }}" 
